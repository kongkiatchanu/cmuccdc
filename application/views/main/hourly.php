		...
		<div class="container mb-5">
			<div class="row mt-3 mb-3">
				...
				<div class="form-filler">
					<div class="form-group row">
							<label class="col-md-2 col-sm-3 col-form-label">เลือกตามจังหวัด :</label>
							...
							<div class="col-md-2 col-sm-4 mb-2"><button class="btn btn-info" id="btn-hourly-filter"><i class="fa fa-filter" aria-hidden="true"></i> กรองข้อมูล</button></div>
						</div>
					</div>
				</div>
			</div>
			<div class="row mt-3 mb-3">
				<div class="col-md-12">
				<p style="color:#99bf3d">อัพเดทข้อมูลเมื่อ : <?=getAVGHour($rsHourly[0]->log_datetime,0)?></p>
					<div class="aqi">
                            ...
                            <div class="tab-pane fade pt-3" id="us_aqi" role="tabpanel">
								<div class="table-responsive">
									<table class="table table-hover ccdc_table">
										...
										<tbody>
									<?php $i=0;foreach($rsHourly as $item){
										if($item->pm25<1000){
