				...
				<div class="col-md-12">
					...
					<div class="tab-content explain" id="myTabContent">
						<div class="p-3 tab-pane fade show active" id="THAQI" role="tabpanel" aria-labelledby="THAQI-tab">
								...
								<div class="col-sm-12">
									...
									<div class="row mb-3">
										<div class="col-md-12">
											...
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChart.php?reportType=h&dataType=pm25&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>
							...
							<style>
							.dforcast{color:#fff;margin: 0;font-size: 16px;background-color: rgb(253,192,78);text-align: center;padding: 5px 0;border-top-right-radius: 10px;border-top-left-radius: 10px;}
							...
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
										<h3 class="text-center aqi-title">ค่าการพยากรณ์ PM2.5 ล่วงหน้า 3 วัน</h3>
									</div>
									<div class="row">
		...
		<script src="<?=base_url()?>assets/plugins/3Dchart/gauge.profile.js?=111"></script>
