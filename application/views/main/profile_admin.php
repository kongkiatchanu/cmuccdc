						...
						<div class="tab-pane fade show active" id="THAQI" role="tabpanel" aria-labelledby="THAQI-tab">
							...
							<div class="row">
								<div class="col-6 mb-3">
									<h5 class="sub-title">PM2.5 เฉลี่ยรายวัน</h5>
									<div class="graph-box">
		...
		<script src="<?=base_url()?>assets/plugins/3Dchart/gauge.js?v=signoutz"></script>
		<script src="<?=base_url()?>assets/plugins/3Dchart/init.jsv?=signoutz"></script>
		<script>
