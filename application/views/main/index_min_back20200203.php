...
<body>
    ...
    <script src="<?=base_url()?>template/js/main.js?version=signOutzV2"></script>
	...
	<script src="<?=base_url()?>template/js/apps.js?v=signOutz"></script>
    <script>
	$.getJSON("<?=$this->config->item('base_api')?>api2/dustboy/stations",function(db){if(db){<?php if($_pmType=="thAQI"){?>$.each(db,function(index,value){var marker=L.marker([value.dustboy_lat,value.dustboy_lon],{icon:L.divIcon({className:"my-custom-pin",iconSize:[35,35],iconAnchor:[0,0],labelAnchor:[-6,0],popupAnchor:[17,0],html:'<div class="signoutz-marker"style="background-color:rgba('+value.th_color+')">'+value.th_aqi+'</div>'})}).addTo(map);marker.on('click',function(e){<?php if($_lang=="thailand"){?>$('#popupDetail p').html(value.dustboy_name);<?php }else{?>$('#popupDetail p').html(value.dustboy_name_en);<?php }?>$('#popupDetail .card-header').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .card-body').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .card-footer').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .number_title').html(value.th_aqi);$('#popupDetail .number_footer').html('PM<sub>2.5</sub><?=$_pmType=="thAQI"?" TH AQI":" US AQI"?>');<?php if($_lang=="thailand"){?>$('#popupDetail .detail_title').html(value.th_title);<?php }else{?>$('#popupDetail .detail_title').html(value.th_title_en);<?php }?>$('#popupDetail .detail_time').html(convertDateFormat(value.log_datetime));$('#popupDetail .card-body .anime img').attr("src",'/template/image/'+value.th_dustboy_icon+'.svg');$('#popupDetail .card-footer span.temp').html(value.temp+' &#8451');$('#popupDetail .card-footer span.humid').html(value.humid+' %');$('#popupDetail .card-footer span.pm25').html('PM<sub>2.5</sub> '+value.pm25+' μg/m<sup>3</sup>');$('#popupDetail').show()})});<?php }else if($_pmType=="usAQI"){?>$.each(db,function(index,value){var marker=L.marker([value.dustboy_lat,value.dustboy_lon],{icon:L.divIcon({className:"my-custom-pin",iconSize:[35,35],iconAnchor:[0,0],labelAnchor:[-6,0],popupAnchor:[17,0],html:'<div class="signoutz-marker"style="background-color:rgba('+value.us_color+')">'+value.us_aqi+'</div>'})}).addTo(map);marker.on('click',function(e){<?php if($_lang=="thailand"){?>$('#popupDetail p').html(value.dustboy_name);<?php }else{?>$('#popupDetail p').html(value.dustboy_name_en);<?php }?>$('#popupDetail .card-header').css("background-color","rgba("+value.us_color+", 1)");$('#popupDetail .card-body').css("background-color","rgba("+value.us_color+", 1)");$('#popupDetail .card-footer').css("background-color","rgba("+value.us_color+", 1)");$('#popupDetail .number_title').html(value.us_aqi);$('#popupDetail .number_footer').html('PM<sub>2.5</sub><?=$_pmType=="thAQI"?" TH AQI":" US AQI"?>');<?php if($_lang=="thailand"){?>$('#popupDetail .detail_title').html(value.us_title);<?php }else{?>$('#popupDetail .detail_title').html(value.us_title_en);<?php }?>$('#popupDetail .detail_time').html(convertDateFormat(value.log_datetime));$('#popupDetail .card-body .anime img').attr("src",'/template/image/'+value.us_dustboy_icon+'.svg');$('#popupDetail .card-footer span.temp').html(value.temp+' &#8451');$('#popupDetail .card-footer span.humid').html(value.humid+' %');$('#popupDetail .card-footer span.pm25').html('PM<sub>2.5</sub> '+value.pm25+' μg/m<sup>3</sup>');$('#popupDetail').show()})});<?php }else{?>$.each(db,function(index,value){var marker=L.marker([value.dustboy_lat,value.dustboy_lon],{icon:L.divIcon({className:"my-custom-pin",iconSize:[35,35],iconAnchor:[0,0],labelAnchor:[-6,0],popupAnchor:[17,0],html:'<div class="signoutz-marker"style="background-color:rgba('+value.th_color+')">'+parseInt(value.pm25).toFixed()+'</div>'})}).addTo(map);marker.on('click',function(e){<?php if($_lang=="thailand"){?>$('#popupDetail p').html(value.dustboy_name);<?php }else{?>$('#popupDetail p').html(value.dustboy_name_en);<?php }?>$('#popupDetail .card-header').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .card-body').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .card-footer').css("background-color","rgba("+value.th_color+", 1)");$('#popupDetail .number_title').html(parseInt(value.pm25).toFixed());$('#popupDetail .number_footer').html('PM<sub>2.5</sub> (μg/m<sup>3</sup>)');<?php if($_lang=="thailand"){?>$('#popupDetail .detail_title').html(value.th_title);<?php }else{?>$('#popupDetail .detail_title').html(value.th_title_en);<?php }?>$('#popupDetail .detail_time').html(convertDateFormat(value.log_datetime));$('#popupDetail .card-body .anime img').attr("src",'/template/image/'+value.th_dustboy_icon+'.svg');$('#popupDetail .card-footer span.temp').html(value.temp+' &#8451');$('#popupDetail .card-footer span.humid').html(value.humid+' %');$('#popupDetail .card-footer span.pm25').html('PM<sub>2.5</sub> '+value.pm25+' μg/m<sup>3</sup>');$('#popupDetail').show()})});<?php }?>}})
	</script>
</body>
