		...
		<div class="container mb-5">
			...
			<div class="row mt-3 mb-3">
				<div class="col-md-12">
					<h3><?=$rsDaily->province_name?></h3>
					<p style="color:#99bf3d">ข้อมูลเฉลี่ยรายวัน : <?=@$rsDaily->stations[0]->log_datetime!=null ? 'วันที่ '.ConvertToThaiDate($rsDaily->stations[0]->log_datetime,1):'ไม่มีข้อมูล'?> (Moving Average Value)</p>
					<hr/>
					<div class="aqi">
                            ...
                            <div class="tab-pane fade pt-3" id="us_aqi" role="tabpanel">
								<div class="table-responsive">
									<table class="table table-hover ccdc_table">
										...
										<tbody>
									<?php $i=0;foreach($rsDaily->stations as $item){if($item->daily_pm25<1000){$i++;?>
