                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <?php for($i = 0;$i <= date('H');$i++){ if(date('Hi')>=$i.'5'){?>
                                        <!-- <a class="dropdown-item" style="font-size: 14px" href="<?=base_url('report/nrct_pm25v7/'.$i);?>" target='_blank'><i class="fas fa-download mr-2"></i> เวลา <?=$i?>:00 น.</a> -->
                                        <a class="dropdown-item" style="font-size: 14px" href="<?=base_url('report/cmu_pm25v4/'.$i);?>" target='_blank'><i class="fas fa-download mr-2"></i> เวลา <?=$i?>:00 น.</a>
                                    <?php }}?>
                                </div>
                            </div>
                        </div>
