		...
		//jaydai
			...
			$get_elect = '';
			if(array_key_exists($rsProfile['dustboy_id'],$list_elect)){
				$get_elect = $list_elect[$rsProfile['dustboy_id']];
			}
		//jaydai
		...
		<?php if($lang=='en'){ ?>
			<input type="hidden" id="db_name" value="<?=$rsProfile['dustboy_name_en']?>">
		<?php }else{ ?>
		...
		<div class="container">
						...
						<div class="p-3 tab-pane fade show active" id="THAQI" role="tabpanel" aria-labelledby="THAQI-tab">
								...
								<div class="col-sm-12">
										...
										<div class="col-md-6">
											<div class="row number forth">
												...
												<div class="col-sm-7 pt-3 pb-3">
													<div id="detail">
														<?php if($lang == 'en'){ ?>
															<p class="des"><?=$rsProfile['value']!=null? $rsProfile['value']->th_title_en: 'ไม่มีข้อมูล'?></p>
															<span class="timer"><i class="far fa-calendar-alt"></i> <?=$rsProfile['value']!=null? getProfileDateEN($rsProfile['value']->log_datetime,0) : '-'?></span>
															<span class="timer"><i class="far fa-clock"></i> <?=$rsProfile['value']!=null? getProfilehourEN($rsProfile['value']->log_datetime) : '-'?></span>
														<?php }else{?>
									...
									<div class="row mb-3">
										...
										<div class="col-md-6">
											...
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChart.php?reportType=d&dataType=pm25thaqi&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-6">
											<h5 class="chart-title">PM<sub>10</sub> Hourly</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=h&dataType=pm10&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
										<div class="col-md-6">
											<h5 class="chart-title">PM<sub>10</sub> Daily</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=d&dataType=pm10&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-6">
											<h5 class="chart-title">Temp Hourly</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=h&dataType=temp&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
										<div class="col-md-6">
											<h5 class="chart-title">Temp Daily</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=d&dataType=temp&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-6">
											<h5 class="chart-title">Humid Hourly</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=h&dataType=humid&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
										<div class="col-md-6">
											<h5 class="chart-title">Humid Daily</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTemp.php?reportType=d&dataType=humid&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>	
									<?php if(!empty($get_elect)){ ?>
										<div class="row mb-3" id="#datameter">
											<div class="col-md-12">
												<h5 class="chart-title"><?=($lang=='en')?'Accumulated electricity consumption':'ปริมาณการใช้ไฟฟ้าสะสม'?></h5>
												<div class="chart_box">
													<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartElect.php?reportType=d&dataType=sensor_energy_kWh&source=<?=$rsProfile['dustboy_id']?>&meter_id=<?=$get_elect?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
												</div>
											</div>
										</div>	
									<?php } ?>
							...
							<div class="row" style="margin-bottom:50px;">
								<div class="col-md-12">
									<div class="mb-3">
										<?php if($lang == 'en'){ ?>
											<h3 class="text-center aqi-title">Thailand's Air Quality Index (THAI AQI)</h3>
										<?php }else{?>
										...
										<table class="table table-hover">
											<thead class="thead-dark">
												<?php if($lang == 'en'){ ?>
													<tr>
														...
														<th class="align-middle" width="7%" style="text-align:center;">AQI</th>
											...
											<?php foreach($rsAir as $val){?>
												<tr style="background-color:<?=$val->air_color?>;height: 100px;">
													<td style="vertical-align: middle;text-align:center;"><img src="/template/img/ccdc-0<?=$val->air_id?>-en.png" height="100"></td>
						...
						<div class="p-3 tab-pane fade" id="USAQI" role="tabpanel" aria-labelledby="USAQI-tab">
								...
								<div class="col-sm-12">
										...
										<div class="col-md-6">
											<div class="row number forus">
												...
												<div class="col-sm-7 pt-3 pb-3">
													<div id="detail">
														<?php if($lang == 'en'){ ?>
															<p class="des"><?=$rsProfile['value']!=null? $rsProfile['value']->us_title_en: 'ไม่มีข้อมูล'?></p>
															<span class="timer"><i class="far fa-calendar-alt"></i> <?=$rsProfile['value']!=null? getProfileDateEN($rsProfile['value']->log_datetime,0) : '-'?></span>
															<span class="timer"><i class="far fa-clock"></i> <?=$rsProfile['value']!=null? getProfilehourEN($rsProfile['value']->log_datetime) : '-'?></span>
														<?php }else{?>
									...
									<div class="row mb-3">
										<div class="col-md-6">
											<h5 class="chart-title">PM<sub>10</sub> Hourly</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTempUS.php?reportType=h&dataType=pm10&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
										<div class="col-md-6">
											<h5 class="chart-title">PM<sub>10</sub> Daily</h5>
											<div class="chart_box">
												<iframe src="https://www.cmuccdc.org/assets/php/getDatabaseColumnChartTempUS.php?reportType=d&dataType=pm10&source=<?=$rsProfile['dustboy_id']?>&key=<?=md5('s'.date('ymdh'))?>" marginheight="0" marginwidth="0" scrolling="no" width="100%" height="250" frameborder="0"></iframe>
											</div>
										</div>
									</div>	
							...
							<div class="row mb-5">
								<div class="col-md-12">
									<div class="mb-3">
										<?php if($lang == 'en'){ ?>
											<h3 class="text-center aqi-title">Air Quality Index scale as defined by<br/> the US-EPA standard</h3>
										<?php }else{?>
											<h3 class="text-center aqi-title">ดัชนีคุณภาพอากาศตามมาตรฐาน US-EPA</h3>
										<?php }?>
									</div>
									<?php if($lang == 'en'){ ?>
										<p><img src="/assets/prophecy/assets/image/us-02.jpg" style="width:100%"></p>
									<?php }else{?>
			...
			<div class="col-md-12 mb-5" style="background-color:#fff">
				...
				<?php if(!empty($get_elect)){ ?>
					<a target="_blank" href="<?=base_url()?>excel_download/<?=$rsProfile['dustboy_id']?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i> Excel (Accumulated electricity consumption)</a>
				<?php } ?>
			</div>
