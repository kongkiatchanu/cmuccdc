<div class="container-getQuotationFile">
	<div class="form-group">
		<div class="col-md-2"><a href="javascript:void(0)" id="btn-delListFile" class="btn btn-small btn-danger btn-del" style="float:right;"><i class="glyphicon glyphicon-minus"></i></a></div>
		<div class="col-md-10">
