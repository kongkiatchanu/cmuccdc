<?php
	...
	if($_GET['reportType']=='h'){
		$param = '?reportType='.$reporttype.'&dataType='.$_GET['dataType'].'&dt='.$dt.'&de='.$de.'&source='.$_GET['source'].'&h_time_start='.$h_time_start.'&h_time_end='.$h_time_end;
	}
...
$(function () {
    ...
    $.each(names, function (i, name) {
		var url = 'https://www.cmuccdc.org/assets/php/jsonDatabaseColumnTemp.php<?=$param?>&key=<?=$_GET['key']?>&callback=?';
