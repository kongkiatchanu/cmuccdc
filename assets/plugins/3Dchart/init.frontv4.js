			...
			/*--------------------*/
			function createGauge25UShr24(name, label, min, max)
			{
				var config = 
				{
					size: 300,
			...
			function createGauges25UShr24()
			{
				createGauge25UShr24("PMRealtime25USAQI24hr", "PM2.5 US AQI");
			}
			
			function createGauge25US(name, label, min, max)
			{
				var config = 
				{
					size: 300,
			...
			function createGauges25US()
			{
				createGauge25US("PMRealtime25USAQI24hr", "PM2.5 US AQI");
			}