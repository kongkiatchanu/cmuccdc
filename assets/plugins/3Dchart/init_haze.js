			...
			function createGauges25DustBoy()
			{
				createGauge25("PMRealtimeAQI25DustBoy", "PM2.5 AQI");
			}
			
			function createGauges10DustBoy()
			{
				createGauge10("PMRealtimeAQI10DustBoy", "PM10 AQI");
			}
